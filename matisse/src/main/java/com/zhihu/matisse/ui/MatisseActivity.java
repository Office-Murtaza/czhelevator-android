    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
         Window window = getWindow();
            ...
            window.setStatusBarColor(getResources().getColor(R.color.dracula_capture));
        }
        ...
        img_top_back = (ImageView) findViewById(R.id.img_top_back);
        ...
        mAlbumsSpinner.setSelectedTextView((TextView) findViewById(R.id.tv_top_title));
        mAlbumsSpinner.setPopupAnchorView(findViewById(R.id.tv_top_title));
