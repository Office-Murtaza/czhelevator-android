...
import com.xinlan.imageeditlibrary.editimage.EditImagerActivity;
...
public class RedoUndoController implements View.OnClickListener {
    ...
    private EditImagerActivity mActivity;
    ...
    public RedoUndoController(EditImagerActivity activity, View panelView) {
