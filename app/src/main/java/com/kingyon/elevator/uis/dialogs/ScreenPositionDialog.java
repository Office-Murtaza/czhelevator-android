 ...
 * @Instructions:屏幕位置
 */
public class ScreenPositionDialog extends Dialog {
    ...
    public ScreenPositionDialog(@NonNull Context context, OnWayString onWayString) {
    ...
    protected int getLayoutId() {
        return R.layout.dialog_screen_position;
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.tv_video_image:
                onWayString.onWay("左屏","L");
                dismiss();
                break;
            case R.id.tv_video:
                onWayString.onWay("中屏","C");
                dismiss();
                break;
            case R.id.tv_image:
                onWayString.onWay("右屏","R");
                dismiss();
                break;
