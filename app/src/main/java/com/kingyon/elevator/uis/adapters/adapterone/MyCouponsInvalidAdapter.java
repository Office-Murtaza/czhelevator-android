...
public class MyCouponsInvalidAdapter extends MultiItemTypeAdapter<Object> {
    boolean expired;

    public MyCouponsInvalidAdapter(Context context, List<Object> mItems, boolean expired) {
    ...
    private class CouponItemDelegate implements ItemViewDelegate<Object> {
        ...
        public int getItemViewLayoutId() {
            return R.layout.fragment_my_coupons_invalid;
        }
