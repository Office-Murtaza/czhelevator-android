...
public class EditCountViewIntUpDown extends FrameLayout {
    ...
    public EditCountViewIntUpDown(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public EditCountViewIntUpDown(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        View view = inflate(getContext(), R.layout.layout_edit_count_up_down, null);
