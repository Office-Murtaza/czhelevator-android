 ...
 * @Instructions:昨日收益
 */
@Route(path = ACTIVITY_EARNINGS_YESTERDAY)
public class EarningsYesterdayActivity extends BaseActivity {
        ...
        NetService.getInstance().getYesterdayIncomeDetailedList(page)
                ...
                .subscribe(new CustomApiCallback<ConentTxEntity<StatisticalEnity<EarningsYesterdayEnity>>>() {
                    ...
                    protected void onResultError(ApiException ex) {
                        ...
                        if (ex.getCode() == -102) {
                            if (page > 1) {
                                ToastUtils.showToast(EarningsYesterdayActivity.this, ex.getDisplayMessage(), 1000);
                            } else {
                    ...
                    public void onNext(ConentTxEntity<StatisticalEnity<EarningsYesterdayEnity>> incomeDetailsEntities) {
                        ...
                        tvTime.setText(DateUtils.getYesterDayTime());
    ...
    private void dataAdd(ConentTxEntity<StatisticalEnity<EarningsYesterdayEnity>> incomeDetailsEntities) {
        ...
        if (incomeAdapter == null || page == 1) {
            incomeAdapter = new IncomeAdapter(EarningsYesterdayActivity.this, list, "1");
