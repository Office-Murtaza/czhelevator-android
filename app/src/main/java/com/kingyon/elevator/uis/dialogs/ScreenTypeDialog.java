...
import static com.kingyon.elevator.constants.Constants.PLAN_TYPE.BUSINESS;
import static com.kingyon.elevator.constants.Constants.PLAN_TYPE.DIY;
 ...
 * @Instructions:屏幕类型
 */
public class ScreenTypeDialog extends Dialog {
    ...
    public ScreenTypeDialog(@NonNull Context context, OnWayString onWayString) {
    ...
    protected int getLayoutId() {
        return R.layout.dialog_screen_type;
    }
    ...
    @OnClick({R.id.tv_video_image, R.id.tv_video, R.id.share_btn_cancel})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.tv_video_image:
                onWayString.onWay("商业广告位",BUSINESS);
                dismiss();
                break;
            case R.id.tv_video:
                onWayString.onWay("DIY广告位",DIY);
                dismiss();
                break;
