...
public class PlanAdapter extends MultiItemTypeAdapter<Object> {
    ...
    private class CellDelegate implements ItemViewDelegate<Object> {
        ...
        public void convert(CommonHolder holder, Object o, int position) {
            ...
            holder.setTextNotHide(R.id.tv_screen, String.format("%s", FormatUtils.getInstance().getCellScreen(item.getTotalScreenNum())));
            holder.setText(R.id.tv_screen_ky,String.format("(%s可用)",item.getTargetScreenNum()));
            ...
            holder.setTextNotHide(R.id.tv_price, Html.fromHtml(String.format(STRING_PRICE1,getTypePrice(item))));
