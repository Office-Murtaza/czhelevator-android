...
public class CellLocationChooseActivity extends BaseSwipeBackActivity implements LocationSource, AMapLocationListener, PoiSearch.OnPoiSearchListener, GeocodeSearch.OnGeocodeSearchListener {
    ...
    private String[] items = {"住宅区", "楼宇", "商场"};
    ...
    public int getContentViewId() {
        return R.layout.activity_cell_location_choose;
    }
        ...
        searchText.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (newText.length() > 0) {
                    ...
                    Inputtips inputTips = new Inputtips(CellLocationChooseActivity.this, inputquery);
...
//                }
                ...
                showToast(String.format("erroCode %s", rCode));
            }
        }
    };
...
//        resultData.add(firstItem);
    ...
    public void onRegeocodeSearched(RegeocodeResult result, int rCode) {
        ...
        if (rCode == AMapException.CODE_AMAP_SUCCESS) {
            ...
            showToast(String.format("error %s", rCode));
        }
    }
