...
public class MessageDetailsAdapter extends RecyclerView.Adapter<MessageDetailsAdapter.ViewHolder> {
    ...
    public MessageDetailsAdapter(Context context, List<MsgNoticeEntity> messageList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        try {
            if (position % 2 == 0) {
                holder.item_container.setSelected(false);
            } else {
                holder.item_container.setSelected(true);
            }
