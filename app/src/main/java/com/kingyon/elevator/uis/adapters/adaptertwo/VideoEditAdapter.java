...
public class VideoEditAdapter extends RecyclerView.Adapter {
    ...
    public void OnClickList( OnClickList onClickList){
        this.onClickList = onClickList;

    }
    @Override
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new EditViewHolder(inflater.inflate(R.layout.video_image_item, parent, false));
    }

    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        EditViewHolder viewHolder = (EditViewHolder) holder;
        LogUtils.e(lists.get(position).path);
        Glide.with(context)
        ...
        viewHolder.img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                onClickList.OnClickList(position,lists.get(position).path);
            }
        });
    }
    ...
    public interface  OnClickList{
        void OnClickList(int position,String path);
