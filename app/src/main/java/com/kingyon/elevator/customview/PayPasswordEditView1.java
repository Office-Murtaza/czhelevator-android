 ...
 * 自定义密支付密码输入框
 */
public class PayPasswordEditView1 extends LinearLayout {
    ...
    public PayPasswordEditView1(Context context) {
        this(context, null);
    }

    public PayPasswordEditView1(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public PayPasswordEditView1(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView() {
        contentView = RelativeLayout.inflate(mContext, R.layout.pay_password_edit_view_layout1, this);
