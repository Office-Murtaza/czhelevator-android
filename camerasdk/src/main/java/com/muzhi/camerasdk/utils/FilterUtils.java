...
public class FilterUtils {
    ...
    public static ArrayList<Filter_Sticker_Info> getStickerList(){
		...
		stickerList.add(new Filter_Sticker_Info(R.mipmap.bg_sticker_01));
		stickerList.add(new Filter_Sticker_Info(R.mipmap.bg_sticker_02));
		stickerList.add(new Filter_Sticker_Info(R.mipmap.bg_sticker_04));
		stickerList.add(new Filter_Sticker_Info(R.mipmap.bg_sticker_05));
		stickerList.add(new Filter_Sticker_Info(R.mipmap.bg_sticker_06));
		stickerList.add(new Filter_Sticker_Info(R.mipmap.bg_sticker_07));
		stickerList.add(new Filter_Sticker_Info(R.mipmap.bg_sticker_08));
		stickerList.add(new Filter_Sticker_Info(R.mipmap.bg_sticker_09));
		stickerList.add(new Filter_Sticker_Info(R.mipmap.bg_sticker_10));
		stickerList.add(new Filter_Sticker_Info(R.mipmap.bg_sticker_11));
		stickerList.add(new Filter_Sticker_Info(R.mipmap.bg_sticker_12));
		stickerList.add(new Filter_Sticker_Info(R.mipmap.bg_sticker_13));
		stickerList.add(new Filter_Sticker_Info(R.mipmap.bg_sticker_14));
		stickerList.add(new Filter_Sticker_Info(R.mipmap.bg_sticker_15));
		stickerList.add(new Filter_Sticker_Info(R.mipmap.bg_sticker_16));
		stickerList.add(new Filter_Sticker_Info(R.mipmap.bg_sticker_17));
		stickerList.add(new Filter_Sticker_Info(R.mipmap.bg_sticker_18));
		stickerList.add(new Filter_Sticker_Info(R.mipmap.bg_sticker_19));
		stickerList.add(new Filter_Sticker_Info(R.mipmap.bg_sticker_20));
		stickerList.add(new Filter_Sticker_Info(R.mipmap.bg_sticker_21));
		stickerList.add(new Filter_Sticker_Info(R.mipmap.bg_sticker_22));
		stickerList.add(new Filter_Sticker_Info(R.mipmap.bg_sticker_23));
		stickerList.add(new Filter_Sticker_Info(R.mipmap.bg_sticker_24));
		stickerList.add(new Filter_Sticker_Info(R.mipmap.bg_sticker_25));
		stickerList.add(new Filter_Sticker_Info(R.mipmap.bg_sticker_26));
		stickerList.add(new Filter_Sticker_Info(R.mipmap.bg_sticker_27));
		stickerList.add(new Filter_Sticker_Info(R.mipmap.bg_sticker_28));
