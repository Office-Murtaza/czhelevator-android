...
public final class ViewfinderView extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (cornerLength <= 0 || cornerWidth <= 0) {
            cornerWidth = dp2px(4);
            cornerLength = dp2px(16);
        }

        // Draw four corner
        paint.setColor(laserColor);
        canvas.drawRect(frame.left - cornerWidth, frame.top - cornerWidth, frame.left, frame.top + cornerLength, paint);
        canvas.drawRect(frame.left, frame.top - cornerWidth, frame.left + cornerLength, frame.top, paint);
        canvas.drawRect(frame.right, frame.top - cornerWidth, frame.right + cornerWidth, frame.top + cornerLength, paint);
        canvas.drawRect(frame.right - cornerLength, frame.top - cornerWidth, frame.right, frame.top, paint);
        canvas.drawRect(frame.left - cornerWidth, frame.bottom - cornerLength, frame.left, frame.bottom + cornerWidth, paint);
        canvas.drawRect(frame.left, frame.bottom, frame.left + cornerLength, frame.bottom + cornerWidth, paint);
        canvas.drawRect(frame.right, frame.bottom - cornerLength, frame.right + cornerWidth, frame.bottom + cornerWidth, paint);
        canvas.drawRect(frame.right - cornerLength, frame.bottom, frame.right, frame.bottom + cornerWidth, paint);
