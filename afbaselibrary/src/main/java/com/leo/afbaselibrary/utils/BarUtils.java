...
public final class BarUtils {
    ...
    public static void setStatusBarLightMode(@NonNull final Activity activity,
        ...
        MIUISetStatusBarLightMode(activity,isLightMode);
        FlymeSetStatusBarLightMode(activity,isLightMode);
     ...
     * @param view The view.
     */
    public static void addMarginTopEqualStatusBarHeight(@NonNull Context context, @NonNull View view) {
     ...
     * @param view The view.
     */
    public static void subtractMarginTopEqualStatusBarHeight(@NonNull Context context, @NonNull View view) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) return;
        Object haveSetOffset = view.getTag(TAG_OFFSET);
        if (haveSetOffset == null || !(Boolean) haveSetOffset) return;
        MarginLayoutParams layoutParams = (MarginLayoutParams) view.getLayoutParams();
     ...
     * @param color         The status bar's color.
     */
    public static void setStatusBarColor(@NonNull Context context, @NonNull final View fakeStatusBar,
                                         @ColorInt final int color) {
     ...
     * @param fakeStatusBar The fake status bar view.
     */
    public static void setStatusBarAlpha(@NonNull Context context, @NonNull final View fakeStatusBar) {
