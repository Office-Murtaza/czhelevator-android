...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    protected boolean isDrawDivider = false;
    ...
    // @formatter:off
    protected static final int[] ATTRS = new int[]{android.R.attr.textSize,
    ...
    protected int tabBackgroundResId = R.drawable.selector_tab;
    ...
    protected void addTextTab(final int position, CharSequence title) {
