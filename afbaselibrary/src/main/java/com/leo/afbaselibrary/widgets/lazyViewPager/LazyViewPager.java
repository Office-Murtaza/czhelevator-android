...
public class LazyViewPager extends ViewPager {
    ...
    public LazyViewPager(Context context, AttributeSet attrs) {
        ...
        setInitLazyItemOffset(a.getFloat(R.styleable.LazyViewPager_init_lazy_item_offset, mInitLazyItemOffset));
        a.recycle();
    }
...
//        }
    ...
    public void setCurrentItem(int item) {
        int lazyPosition = item;
        if (mLazyPagerAdapter != null && mLazyPagerAdapter.isLazyItem(lazyPosition)) {
            mLazyPagerAdapter.startUpdate(this);
            mLazyPagerAdapter.addLazyItem(this, lazyPosition);
            mLazyPagerAdapter.finishUpdate(this);
        }
