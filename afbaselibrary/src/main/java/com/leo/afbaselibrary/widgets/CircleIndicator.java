...
/**
 * Created by arvin on 2016/9/13 14:58
 */
public class CircleIndicator extends LinearLayout {
    ...
    private void createIndicators() {
        ...
        for (int i = 0; i < count; i++) {
            View indicator = null;
            if (currentItem == i) {
                indicator = addIndicator(mIndicatorBackgroundResId, mImmediateAnimatorOut);
            } else {
                indicator = addIndicator(mIndicatorUnselectedBackgroundResId, mImmediateAnimatorIn);
            }
//            if (mViewpager instanceof ViewPager && i == 0 || i == count - 1) {
...
//            }
    ...
    private View addIndicator(@DrawableRes int backgroundDrawableId, Animator animator) {
