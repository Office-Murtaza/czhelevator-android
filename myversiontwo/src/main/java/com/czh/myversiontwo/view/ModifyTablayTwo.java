 ...
 * @Instructions:
 */
public class ModifyTablayTwo extends HorizontalScrollView {
    private ModifyTablayTwo.OnTabLayoutItemSelectListener onTabLayoutItemSelectListener;
    ...
    private ModifyTablayTwo.TabLayoutOnPageChangeListener mPageChangeListener;
    ...
    private static class StaticHandler extends Handler {
        ...
        private final WeakReference<ModifyTablayTwo> mParent;

        public StaticHandler(Context context, ModifyTablayTwo view) {
        ...
        public void handleMessage(Message msg) {
            ...
            ModifyTablayTwo parent = mParent.get();
    ...
    public ModifyTablayTwo(Context context) {
        this(context, null);
    }

    public ModifyTablayTwo(Context context, AttributeSet attrs) {
        super(context, attrs);
        viewHeight = dip2px(getContext(), 40);
        innerLeftMargin = dip2px(getContext(), 15);
        innerRightMargin = dip2px(getContext(), 15);
        mHandler = new ModifyTablayTwo.StaticHandler(context, this);
    ...
    public void setupWithViewPager(@Nullable ViewPager viewPager) {
        if (viewPager != null) {
            ...
            if (mPageChangeListener == null) {
                mPageChangeListener = new ModifyTablayTwo.TabLayoutOnPageChangeListener(this);
            }
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<ModifyTablayTwo> mTabLayoutRef;
        private int mPreviousScrollState;
        private int mScrollState;

        public TabLayoutOnPageChangeListener(ModifyTablayTwo tabLayout) {
...
//            }
        ...
        public void onPageSelected(final int position) {
            final ModifyTablayTwo tabLayout = mTabLayoutRef.get();
...
//                tabLayout.selectTab(tabLayout.getTabAt(position), updateIndicator);
    ...
    public void setOnTabLayoutItemSelectListener(ModifyTablayTwo.OnTabLayoutItemSelectListener listener) {
